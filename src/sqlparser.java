  ...
  static final public BooleanTest booleanTest() throws ParseException {
    ...
    case LEFT_PAREN:
      e = parenthesizedBoolExpr();
                  {if (true) return new BooleanTest(e);}
      break;
    default:
      jj_la1[22] = jj_gen;
      jj_consume_token(-1);
...
// show table query is just <SHOW TABLES >
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xfe20,0xfe00,0xfe00,0x0,0x60000,0x10000,0x60000,0x0,0x1c0,0x0,0x0,0x0,0x20000000,0x0,0x10000000,0x200000,0x800000,0x0,0x200000,0x2000000,0x1000000,0x4000000,0x0,0x0,0x0,0x20010000,0x800000,};
   }
